...
<head>
    ...
    <script>
        ...
        function checkDegree() {
            ...
            window.location.replace("faculty_register.jsp?deg_JS=" + select);
        }
    ...
    <form class="form-default" name="myform" action="faculty_register.jsp" method="POST">
        ...
        <div class="login-form reg">
            ...
            <div class="form-input">
                <input type="text" id="name" name="name" placeholder="Full name" pattern="[A-Z a-z]{2,}\s{1}[A-Z a-z]{3,}" title="Enter First Name and Last Name" required>
            </div>
            <div class="form-input">
                <input type="text" id="username" name="username" placeholder="Username" pattern="[A-Za-z0-9]{6,}" title="Enter First Username" required>
            </div>
            <div class="form-input">
        ...
        <%
            ...
            try {
                ...
                String checkUsernameSql = "SELECT COUNT(*) FROM faculty WHERE username = '" + username + "'";
                ...
                String checkEmailSql = "SELECT COUNT(*) FROM faculty WHERE email_id = '" + email + "'";
