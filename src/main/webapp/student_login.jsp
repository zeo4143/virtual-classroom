...
%>
	...
	try
	{
        ...
        String sql = "SELECT * FROM student WHERE (username = '" + usernameOrEmail + "' OR email_id = '" + usernameOrEmail + "') AND password = SHA1('" + password + "')";
		...
		{
			// create a SQL statement
			String sql1 = "select * from student WHERE (username = '" + usernameOrEmail + "' OR email_id = '" + usernameOrEmail + "')";
